...
/**
 * naturalStoneFinishesPage — singleton holding all editor-managed
 * copy and media for /products/natural-stone-finishes.
 *
 * Layout consumed:
 ...
 * (default "natural-stone-finishes"). Editors create a Product per
 * finish and tag the collection.
 */
export default defineType({
  name: "naturalStoneFinishesPage",
  ...
  preview: {
    prepare() {
      return { title: "Natural Stone Finishes Page" };
    },
  },
});
