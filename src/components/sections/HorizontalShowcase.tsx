...
const showcaseItems = [
  {
    ...
    description:
      "Exquisite mineral surfaces crafted by combining artistic vision & innovation",
    image:
  ...
  },
  {
    title: "Ecosurfaces",
    description:
      "Revolutionary zero-silica surfaces crafted with people and environment in mind",
    image:
  ...
  },
  {
    title: "Semi-Precious",
    description:
      "True jewels of nature that lift aesthetics to unsurpassed extravagance",
    image:
          ...
          {showcaseItems.map((item, i) => (
            ...
            >
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-white/5">
                ...
                {/* Number */}
                <div className="absolute top-6 left-6 text-xs font-medium tracking-[0.25em] text-white/50">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs font-medium tracking-[0.25em] uppercase text-white/60 group-hover:text-white transition-colors">
                    Explore
