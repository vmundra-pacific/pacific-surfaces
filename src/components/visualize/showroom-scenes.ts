...
export const SHOWROOM_SCENES: ShowroomScene[] = [
  // --------------------------------------------------------------------- Kitchen
  {
    ...
    category: "Kitchen",
    description:
      "Walk around a Pacific island and see both the top and the waterfall run.",
    palette: {
      floor: softWood,
      backWall: warmWhite,
      sideWall: "#e6ded1",
    ...
    props: [
      ...
      {
        id: "back-cabinet-left",
        size: [2, 0.9, 0.6],
        position: [-1.5, 0.45, -2.4],
        color: warmWhite,
        roughness: 0.7,
      },
      {
        id: "back-cabinet-right",
        size: [2, 0.9, 0.6],
        position: [1.5, 0.45, -2.4],
        color: warmWhite,
        roughness: 0.7,
  ...
  // --------------------------------------------------------------------- Bathroom
  {
    ...
    category: "Bathroom",
    description:
      "A floating vanity and shower niche — see how veining reads at both scales.",
    palette: {
      floor: "#d8d4cf",
      backWall: coolWhite,
      sideWall: "#cfd4da",
  ...
  // --------------------------------------------------------------------- Living
  {
    ...
    category: "Living",
    description:
      "A full-height fireplace surround. The single slab reads from across the room.",
    palette: {
      floor: "#b3987a",
      backWall: "#efe9df",
      sideWall: "#e5e0d5",
