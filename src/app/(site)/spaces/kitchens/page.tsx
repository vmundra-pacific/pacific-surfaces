...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "Continuous Pacific surfaces carry the worktop pattern up the wall — bookmatched veining, no grout lines, no seams. Beyond Stone specifies the same stone for the splashback at large-format scale.",
